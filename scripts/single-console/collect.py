...
class teleoperation:
    ...
    def __init__(self, clutch_topic, run_period, align_mtm, operator_present_topic="", alpha = 0.5, **kwargs):
        ...
        self.output_csv_path = f"/home/xle6/dvrk_teleop_data/Aug_18/data/{self.start_time:.6f}-DVRK-Last-Right-Train-joint_data.csv"
    ...
    def run_following(self):
        ...
        if self.recording_enabled and self.record_size >= 100000:
