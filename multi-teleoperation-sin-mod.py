...
class teleoperation:
    ...
    def run_following(self):
        ...
        # puppet_measured_cf_force[0:3] = puppet_measured_cf_force[0:3] * 1.5
    ...
    def run(self):
        ...
        numpy.savetxt('vel_unstab_array.txt', self.y_data_l, fmt='%f', delimiter=' ', header='Column1 Column2 Column3', comments='')
        numpy.savetxt('vel_unstab_array_exp.txt', self.y_data_l_expected, fmt='%f', delimiter=' ', header='Column1 Column2 Column3', comments='')
        numpy.savetxt('vel_unstab_m1_force_0520.txt', self.m1_force, fmt='%f', delimiter=' ', header='Column1 Column2 Column3', comments='')
        numpy.savetxt('vel_unstab_m2_force_0520.txt', self.m2_force, fmt='%f', delimiter=' ', header='Column1 Column2 Column3', comments='')
        numpy.savetxt('vel_unstab_puppet_force_0520.txt', self.puppet_force, fmt='%f', delimiter=' ', header='Column1 Column2 Column3', comments='')
