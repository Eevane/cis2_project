...
file_path = 'model_0702_03'
true_pos = np.loadtxt(f'0702/multi_array_{file_path}.txt', skiprows=1)
expect_pos = np.loadtxt(f'0702/multi_array_exp_{file_path}.txt', skiprows=1)
gamma = -0.3
beta = 0.5

m1_force = np.loadtxt(f'0702/multi_m1_force_{file_path}.txt', skiprows=1, usecols=(0, 1, 2))
m2_force = np.loadtxt(f'0702/multi_m2_force_{file_path}.txt', skiprows=1, usecols=(0, 1, 2))
puppet_force = np.loadtxt(f'0702/multi_puppet_force_{file_path}.txt', skiprows=1, usecols=(0, 1, 2))
