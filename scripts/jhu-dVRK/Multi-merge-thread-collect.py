...
class teleoperation:
    ...
    def __init__(self, mtm1, mtm2, puppet, clutch_topic, run_period, align_mtm, operator_present_topic="", alpha = 0.5, beta = 0.5):
        ...
        self.output_csv_path = f"/home/xle6/dvrk_teleop_data/august1th/{self.start_time:.6f}-MTML-Mul-Test-joint_data.csv"
    ...
    def set_velocity_goal(self, v, base=1.1, max_gain=1.165, threshold=0.1):
    ...
    def run_following(self):               
        ...
        puppet_measured_cv[3:6] *= 0.8      # scale down the angular velocity by 0.2
        ...
        if self.recording_enabled and self.record_size >= 20000:
    ...
    def run(self):
        ...
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/PSM_internal.txt', self.puppet.internal_torque_record_PSM, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/PSM_total.txt', self.puppet.total_torque_record_PSM, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/PSM_force.txt', self.puppet.internal_force_PSM, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTML_internal.txt', self.master1.internal_torque_record_MTML, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTML_total.txt', self.master1.total_torque_record_MTML, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTML_force.txt', self.master1.internal_force_MTML, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTMR_internal.txt', self.master2.internal_torque_record_MTMR, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTMR_total.txt', self.master2.total_torque_record_MTMR, fmt='%f', delimiter=' ', comments='')
        # numpy.savetxt('/home/xle6/dvrk_teleop_data/July_29/MTMR_force.txt', self.master2.internal_force_MTMR, fmt='%f', delimiter=' ', comments='')
...
class ARM:
    ...
    #     # print(f"input mean is: {self.firstmodel.input_mean}")
    #     # print(f"input std is: {self.firstmodel.input_std}")
...
if __name__ == '__main__':
    ...
    # merge models
    model_paths = (mtm1.firstmodel.onnx_path,mtm1.lastmodel.onnx_path, mtm2.firstmodel.onnx_path ,mtm2.lastmodel.onnx_path,
                       psm.firstmodel.onnx_path, psm.lastmodel.onnx_path)
    model_merger = ModelMerger(model_paths,path_root + "merged_model.onnx")
    if not os.path.exists(path_root + "merged_model.onnx"):
