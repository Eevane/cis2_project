...
class teleoperation:
    ...
    def run_following(self):               
        ...
        # Move
        self.puppet.body_servo_cf(force_goal)
        ...
        # Move
        self.master1.servo_cp(master1_cartesian_goal)
        self.master2.servo_cp(master2_cartesian_goal)
    ...
    def run(self):
        ...
        # save data
        save_path = "/home/xle6/dvrk_teleop_data/Oct_18/2ch_FP"
