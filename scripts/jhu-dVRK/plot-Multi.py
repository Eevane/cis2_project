...
true_pos = np.loadtxt('multi_array_0603.txt', skiprows=1)
expect_pos = np.loadtxt('multi_array_exp_0603.txt', skiprows=1)
error = np.abs(true_pos - expect_pos) * 1000

m1_force = np.loadtxt('multi_m1_force_0603.txt', skiprows=1)
m2_force = np.loadtxt('multi_m2_force_0603.txt', skiprows=1)
puppet_force = np.loadtxt('multi_puppet_force_0603.txt', skiprows=1)
total = m1_force + m2_force
