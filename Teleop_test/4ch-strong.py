...
""" 4-channel, strong connected structure """
...
class teleoperation:
    ...
    def run_following(self):               
        ...
        master1_translation_goal = self.position_gain * (0.5 * puppet_translation_scaled + 0.5 * master2_translation)
        master1_position = master1_translation_goal + master1_initial_trans
        # set translation of mtm2
        master2_translation_goal = self.position_gain * (0.5 * puppet_translation_scaled + 0.5 * master1_translation)
        ...
        # ================ leave rotation goal be R_PSM for strong architecture =============================================
        # set rotation of mtm1
        ...
        # set velocity goal
        master1_velocity_goal = self.velocity_gain * (0.5 * puppet_measured_cv_scaled + 0.5 * master2_measured_cv)
        master2_velocity_goal = self.velocity_gain * (0.5 * puppet_measured_cv_scaled + 0.5 * master1_measured_cv)
    ...
    def run(self):
        ...
        # save data
        save_path = "/home/xle6/dvrk_teleop_data/Oct_18/4ch_stro"
