...
class teleoperation:
    ...
    def run(self):
        ...
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/PSM_internal.txt', self.puppet.internal_torque_record_PSM, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/PSM_total.txt', self.puppet.total_torque_record_PSM, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/PSM_force.txt', self.puppet.internal_force_PSM, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTML_internal.txt', self.master1.internal_torque_record_MTML, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTML_total.txt', self.master1.total_torque_record_MTML, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTML_force.txt', self.master1.internal_force_MTML, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTMR_internal.txt', self.master2.internal_torque_record_MTMR, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTMR_total.txt', self.master2.total_torque_record_MTMR, fmt='%f', delimiter=' ', comments='')
        numpy.savetxt('/home/xle6/dvrk_teleop_data/July_11/MTMR_force.txt', self.master2.internal_force_MTMR, fmt='%f', delimiter=' ', comments='')
