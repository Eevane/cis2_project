    ...
    def run_following(self):               
        ...
        if self.recording_enabled:
            with open("joint_data.csv", "a", newline='') as f:
                ...
                master1_q = list(master1_js[0])
                master1_dq = list(master1_js[1])
                master1_torque = list(master1_js[2])

                master2_q = list(master2_js[0])
                master2_dq = list(master2_js[1])
                master2_torque = list(master2_js[2])
