...
class teleoperation:
    ...
    def __init__(self, mtm1, mtm2, puppet, clutch_topic, run_period, align_mtm, operator_present_topic="", alpha = 0.5, beta = 0.5):
        ...
        self.output_csv_path = f"/home/xle6/dvrk_teleop_data/July_11/{self.start_time:.6f}-MTMR-Mul-Train-joint_data.csv"
    ...
    def enter_aligning(self):
        ...
        # self.master1.arm.use_gravity_compensation(False)
        # self.master2.arm.use_gravity_compensation(False)
    ...
    def run(self):
        ...
        puppet_initial_position = numpy.array([0, 0, 0.15, 0, 0, 0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--interval', type=float, default=0.000667,
