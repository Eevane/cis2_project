...
# X-axis force
axs[0].plot(x, m1_force[:,0], linewidth=lw, label='m1_force_x')
axs[0].plot(x, m2_force[:,0], linewidth=lw, label='m2_force_x')
...
# Y-axis force
axs[1].plot(x, m1_force[:,1], linewidth=lw, label='m1_force_y')
axs[1].plot(x, m2_force[:,1], linewidth=lw, label='m2_force_y')
...
# Z-axis force
axs[2].plot(x, m1_force[:,2], linewidth=lw, label='m1_force_z')
axs[2].plot(x, m2_force[:,2], linewidth=lw, label='m2_force_z')
