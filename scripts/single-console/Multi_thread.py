...
class teleoperation:
    ...
    def set_velocity_goal(self, v, base=1.12, max_gain=1.2, threshold=0.01):
...
class ARM:
    ...
    def externalforce_prediction(self):
        ...
        print(f"internal_torque: {internal_torque}")
...
class model(threading.Thread):
    ...
    def run(self):
        while self.running:
            ...
            # master2
            master2_external_f = self.master2.externalforce_prediction()   # (6,) numpy array
            master2_external_f[0:3] *= -1.0
            master2_external_f[3:6] *= 0  # turn off torque

            # puppet
            puppet_external_f = self.puppet.externalforce_prediction()   # (6,) numpy array
